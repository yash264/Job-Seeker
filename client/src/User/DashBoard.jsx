...
function DashBoard() {
    ...
    useEffect(()=>{
        try{
            const response = axios.post('http://localhost:4000/api/dashBoard',{name:name,gender:gender,email:email,mobile:mobile,qualification:qualification,city:city,state:state});
